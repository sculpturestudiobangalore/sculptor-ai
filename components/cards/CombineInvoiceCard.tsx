...
export default function CombineInvoiceCard({
    invoices,
    clientName,
    projectName,
    previewTotal,
        ...
        <div className="w-full rounded-2xl border border-violet-500/30 bg-linear-to-br from-violet-900/20 to-purple-900/20 p-4 shadow-xl backdrop-blur-sm sm:p-6">
            ...
            <div className="mb-4 flex items-start justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-white/70">
                        Merge {invoices.length} invoices into a single new invoice.
                    </p>
                </div>
                {onCancel && (
                    <button
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div className="text-xs text-white/50">{inv.itemCount} items • {inv.date}</div>
                            </div>
                        </div>
            ...
            <div className="mb-6 rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-4">
                ...
                <p className="mt-2 text-xs text-emerald-200/60 text-center">
                    A new invoice will be created containing all items from the above invoices.
                    The original invoices will be marked as merged/cancelled.
                </p>
            </div>
